...
public class GeneratorController {
	 ...
	 */
	public ResponseResult createTable(@RequestBody String body) {
	 ...
	 */
	public ResponseResult alterTable(@RequestBody String body) {
		JSONObject object = JSON.parseObject(body);
		String type = object.getString("type");
	 ...
	 */
	public ResponseResult dropTable(@RequestBody String body) {
		JSONObject object = JSON.parseObject(body);
		String type = object.getString("type");
		TableDefinition t = new TableDefinition();
		t.setSchemaName(object.getString("schema_name"));
	 ...
	 */
	public ResponseResult truncateTable(@RequestBody String body) {
		JSONObject object = JSON.parseObject(body);
		String type = object.getString("type");
