...
public class StringColumn extends Column {
	...
	public BigInteger asBigInteger() {
		...
		try {
			...
			throw new RuntimeException(String.format("String[\"%s\"]不能转为BigInteger .", this.asString()));
		}
	}
	...
	public Long asLong() {
		...
		try {
			...
			throw new RuntimeException(String.format("String[\"%s\"]不能转为Long .", this.asString()));
		}
	}
