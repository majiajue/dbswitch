package com.weishao.dbswitch.dbwriter.gpdb.copy;
...
import com.weishao.dbswitch.dbwriter.gpdb.copy.element.DoubleColumn;
import com.weishao.dbswitch.dbwriter.gpdb.copy.element.LongColumn;
...
public class GreenplumCopyWriter {
	...
	public GreenplumCopyWriter(Connection connection,String schemaName,String tableName, Map<String, Integer> columnMetaData) throws IOException {
			...
			for (int i = 1; i <= metaData.getColumnCount(); i++) {
				...
				default:
					throw new RuntimeException(String.format(
							"您的配置文件中的列配置信息有误. 不支持数据库读取这种字段类型. 字段名:[%s], 字段名称:[%s], 字段Java类型:[%s].",
