...
public class StructureController extends BaseController {
	...
	@Autowired
	@Qualifier("MigrationConvertService")
	 ...
	 */
	public Map<String, Object> queryDatabaseSchemas(@RequestBody String body) {
	 ...
	 */
	public Map<String, Object> queryDatabaseSqlInfo(@RequestBody String body) {
		JSONObject object = JSON.parseObject(body);
		String type=object.getString("type");
		String host=object.getString("host");
		Integer port=object.getInteger("port");
	 ...
	 */
	public Map<String, Object> queryDatabaseTableSQL(@RequestBody String body) {
		JSONObject object = JSON.parseObject(body);
		String type=object.getString("type");
		String host=object.getString("host");
		Integer port=object.getInteger("port");
	 ...
	 */
	public Map<String, Object> testQuerySql(@RequestBody String body) {
		JSONObject object = JSON.parseObject(body);
		String type=object.getString("type");
		String host=object.getString("host");
		Integer port=object.getInteger("port");
